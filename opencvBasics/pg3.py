...
7. we are going to create the explicit windows before im show method call  and method for that called name windows 
8. We can destry the window by calling hte name cv2.destroyWindow('Lena')
