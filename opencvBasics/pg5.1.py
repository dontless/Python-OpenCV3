# -*- coding: utf-8 -*-
"""
Created on Sat Sep 15 19:32:26 2018
...
person with his face and ou could easily judge with his face 
 ...
 let seee demo 
 these all value relevant to gray scale  images 
...
def main():
     ...
     img1=cv2.imread(impath,0) # read in the color formT AS IT IS 
     print((img1)) # this will print actual number format of image
     ...
     print(img1.shape)# going to see the shape of the image  i.e is the resolution of the image 
                            # here 512 is standered resolution and and 2 is the number of the channel of gray scale image 
                             # 0 means black 255 means white 
                             
      #next see number of image dimension have 
     print(img1.ndim)# ndim is the property which return the number of dimention i.e- 2 
     
     print(img1.size) # going to see the size of the image  i.e- 512x512= 262144
